...
const FuelPumpEdit = ({ data }: { data: FuelPumpEditData }) => {
    ...
    const [selectedFuelTypes, setSelectedFuelTypes] = useState<string[]>(data.fuelTypes || []);
    const [selectedEmployees, setSelectedEmployees] = useState<string[]>(data.employeeIds || []);
